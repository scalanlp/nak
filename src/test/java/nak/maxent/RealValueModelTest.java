...
public class RealValueModelTest extends TestCase {
  ...
  public void testRealValuedWeightsVsRepeatWeighting() throws IOException {
    GISModel realModel;
    RealValueFileEventStream rvfes1 = new RealValueFileEventStream("src/test/resources/data/chalk/learn/real-valued-weights-training-data.txt");
    try {
    ...
    FileEventStream rvfes2 = new FileEventStream("src/test/resources/data/chalk/learn/repeat-weighting-training-data.txt");
    try {
